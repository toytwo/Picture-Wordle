...
public abstract class RevealPanel extends InteractivePanel {
     ...
     */
    protected BufferedImage image; // the image to be revealed
    /**
     * How much of the screen width the revealPanel occupies. guessPanel will occupy
     * the other part (1-this).
     */
    protected double REVEAL_PANEL_SCREEN_PERCENTAGE = 5.0 / 6.0; // screen space occupied by revealPanel
